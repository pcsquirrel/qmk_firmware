...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_NORMAL] = LAYOUT_seventy_ansi(
		  KC_E, KC_1,KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1,  \
		  KC_E, KC_1,KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1,  \
		  KC_E, KC_1,KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1,  \
		  KC_E, KC_1,KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1,  \
		  KC_E, KC_1,KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1, KC_E, KC_1,  \
...
KC_GRAVE, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS, KC_EQL,  KC_BSPC, KC_DELETE,  KC_DELETE, \
 KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC, KC_RBRC,  KC_PGUP,  KC_PGUP, KC_PGUP, \
KC_CAPS, KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT, KC_ENT,   KC_SLASH,KC_PGDOWN,KC_PGDOWN, \
KC_LSPO, XXXXXXX,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH, KC_RSPC,KC_UP,  TT(2), TT(2), \
KC_LCTL, KC_LGUI,KC_LALT,KC_SPC,KC_SPC,KC_SPC,KC_SPC,KC_SPC,KC_SPC,KC_SPC,                 KC_RALT,MO(1),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT ,
